...
%}
[u_face, cov_face, u_non_face, cov_non_face] = get_mean_covar('hG');
...
figure(2);
subplot(121), plot(face, face_pdf), axis([0 1 0 20]), title(face_title);
subplot(122), plot(non_face, non_face_pdf), axis([0 1 0 20]), title(non_face_title);
pause
