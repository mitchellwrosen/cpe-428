...
%}
[u_face, cov_face, u_non_face, cov_non_face] = get_mean_covar('h');
...
figure(2);
subplot(121), plot(face, face_pdf), axis([0 1 0 4]), title('Skin pixels')%, title(face_title);
subplot(122), plot(non_face, non_face_pdf), axis([0 1 0 4]), title('Non-skin pixels')%, title(non_face_title);
pause
